# -*- coding: utf-8 -*-
"""
<plugin key="EaseeCloudAutoDiscoveryV1000" name="Easee Domoticz plugin v10.5.14" author="Richard Leunk" version="10.5.14"
        wikilink="https://wiki.domoticz.com/Developing_a_Python_plugin"
        externallink="https://github.com/rleunk/easee-domoticz">
    <description>
        <h2>Easee Domoticz plugin v10.5.14</h2><br/>
...
class BasePlugin:
    ...
    # ---- logging ----
    def log(self, msg): Domoticz.Log(f'[Easee v10.5.14] {msg}')
    def debug(self, msg):
        if Parameters.get('Mode6') == 'Debug':
            Domoticz.Debug(f'[Easee v10.5.14] {msg}')
    def error(self, msg): Domoticz.Error(f'[Easee v10.5.14] {msg}')
