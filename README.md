# Easee Domoticz plugin v10.9.13

**Easee-laadpalen, Equalizer (meterkast) en Tibber in Domoticz — modulaire plugin, custom tegeliconen, compacte statusweergave.**

![Version](https://img.shields.io/badge/version-10.9.13-blue)
![License](https://img.shields.io/badge/license-MIT-green)
![Platform](https://img.shields.io/badge/platform-Domoticz-orange)

> **Status:** v10.9.13 — *stable testing* (pauze in actieve ontwikkeling). Getest met 2× Charge Lite, 1× Equalizer en Tibber. Bugreports welkom via [Issues](https://github.com/rleunk/easee-domoticz/issues).
...
- Laatste release: **[v10.9.13](https://github.com/rleunk/easee-domoticz/releases/tag/v10.9.13)** — 429 fail-fast; hardware-thread fix
