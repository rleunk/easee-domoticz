...
![Version](https://img.shields.io/badge/version-10.2.5-blue)
...
5. **Voeg plugin toe in Domoticz UI**
   - Setup → Hardware
   - Type: "Easee AutoDiscovery Compact v10.2.5"
...
**Versie 10.2.5** - Gemaakt door Richard Leunk
