...
![Version](https://img.shields.io/badge/version-10.2.4-blue)
...
5. **Voeg plugin toe in Domoticz UI**
   - Setup → Hardware
   - Type: "Easee AutoDiscovery Compact v10.2.4"
...
**Versie 10.2.4** - Gemaakt door Richard Leunk
