...
**Language / Taal:** [English](STABLE.md) · **Nederlands** (this page)

Dit project heeft **twee versielijnen**: **v1** (productie op `main`) en legacy **v10** (bewaard op branch `legacy/v10`). Zie [VERSIONING.nl.md](VERSIONING.nl.md).
...
Zie [CHANGELOG.md](CHANGELOG.md) en [README.nl.md](README.nl.md) voor details per versie.
