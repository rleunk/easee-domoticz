...
**Language:** **English** · [Nederlands](INSTALL.md)
...
> **Branches:** **`main`** = production **1.1.6** · **`v1`** = development · **`legacy/v10`** = v10.11.6. See [STABLE.en.md](STABLE.en.md).
...
Set **Price source (Mode9)**. See [docs/en/CONFIGURATION.md](docs/en/CONFIGURATION.md).
...
Full legacy install details: [INSTALL.md](INSTALL.md) (Dutch).

---

## Git authentication

GitHub requires a **Personal Access Token** for HTTPS, not your password. See [docs/en/GIT_SETUP.md](docs/en/GIT_SETUP.md).
...
| HTTP 429 | Set Mode1 to **60 sec** — [docs/en/TROUBLESHOOTING.md](docs/en/TROUBLESHOOTING.md#http-429-rate-limit-easee-api) |
| No icons | Re-upload zip — above |

Full guide: [docs/en/TROUBLESHOOTING.md](docs/en/TROUBLESHOOTING.md).
