...
**Language:** **English** (this page) · [Nederlands](README.md)
...
> **Status (production):** **`main`** = **1.1.6** — NL/EN UI (Mode30), LB phase detail, Tibber fallbacks, adaptive poll; **11 tiles + LoadBal**. See [STABLE.en.md](STABLE.en.md), [VERSIONING.en.md](VERSIONING.en.md), [docs/en/RELEASE_1.1.6.md](docs/en/RELEASE_1.1.6.md).
>
...
> Git auth: [docs/en/GIT_SETUP.md](docs/en/GIT_SETUP.md) · Issues: [docs/en/TROUBLESHOOTING.md](docs/en/TROUBLESHOOTING.md)
...
See [CHANGELOG.md](CHANGELOG.md) for full history (Dutch/English release notes in [docs/en/](docs/en/)).
...
Full guide: [docs/en/CONFIGURATION.md](docs/en/CONFIGURATION.md).
...
Restart the Easee hardware item in Domoticz. See [INSTALL.en.md](INSTALL.en.md) and [STABLE.en.md](STABLE.en.md).
...
- **All English docs:** [docs/en/README.md](docs/en/README.md)
