...
**Language / Taal:** [English](../TROUBLESHOOTING.md) · **Nederlands** (this page)

> **Versies:** **main** — **1.1.6** (productie) · Legacy **v10.11.6** op branch `legacy/v10`  
> Installatie: [INSTALL.nl.md](../INSTALL.nl.md) · English: [INSTALL.md](../INSTALL.md) · Configuratie: [CONFIGURATION.md](CONFIGURATION.md)
...
Zie [INSTALL.nl.md — Custom iconen](../../INSTALL.nl.md#custom-iconen-handmatig-uploaden).
