...
**Language / Taal:** [English](../CONFIGURATION.md) · **Nederlands** (this page)
...
> **README-demo:** de gesanitiseerde screenshot in [README.nl.md](../../README.nl.md) toont **11 actieve tegels + LoadBal** met **twee laadpalen** (*Lader 1*, *Lader 2*) plus globale en Equalizer-tegels — compacte v10.11-layout.
...
Auto-load bij start; anders handmatige upload — zie [INSTALL.nl.md](../../INSTALL.nl.md#custom-iconen-handmatig-uploaden).
