...
Kort overzicht — **v10.9.32-stable** is de bewaarde stabiele baseline; **v10.10.0** = Tibber kwartierprijzen, Dagrapport, laadhints, configureerbaar Beste laden.
...
- **16 tegels** met Tibber (2 laders + EQ); tag `v10.9.32-stable` bewaard.
...
2× Charge Lite, 1× Equalizer, Tibber (Mode7) — **16 tegels** (zie [CONFIGURATION.md](CONFIGURATION.md#verwachte-tegels-referentie)). Kosten-tegels, Dagrapport en Vandaag kWh bevestigd werkend (Richard, 19-06-2026).
