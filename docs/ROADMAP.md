...
Kort overzicht — **v10.9.28** is de huidige *stable testing* functionele release; **v10.9.29** = logging-opruiming; **v10.9.30** = Tibber-token backup; **v10.9.31** = optionele API-logs naar DEBUG + docs/mockups. Pauze in actieve ontwikkeling.
...
| Status (online, LB aan/uit, fase-detail) | Observations + siteStructure | Werkt; LB kan **Uit** tonen terwijl Easee-app anders toont als API geen LB-state levert |
