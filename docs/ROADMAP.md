...
Kort overzicht — **v10.11.1-stable** is de huidige stabiele baseline; **v10.10.8-stable** blijft bewaard voor rollback. Zie [STABLE.md](../STABLE.md).
...
- **Stable release** — tag `v10.11.1-stable` (aanbevolen productie-baseline).
