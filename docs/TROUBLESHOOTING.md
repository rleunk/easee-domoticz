...
sudo tail -f /home/domoticz/domoticz.log | grep "Easee v10.0.1"
...
2. Klik op "Easee AutoDiscovery v10.0.1"
3. Zet Mode6 = "Debug"
4. Klik Update
...
sudo grep "Easee v10.0.1.*error" /home/domoticz/domoticz.log
