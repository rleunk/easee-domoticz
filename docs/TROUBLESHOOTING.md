...
sudo tail -f /home/domoticz/domoticz.log | grep "Easee v9.1.0"
...
2. Klik op "Easee AutoDiscovery v9.1.0"
3. Zet Mode6 = "Debug"
4. Klik Update
...
sudo grep "Easee v9.1.0.*error" /home/domoticz/domoticz.log
